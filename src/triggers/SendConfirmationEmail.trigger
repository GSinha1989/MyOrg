trigger SendConfirmationEmail on Session_Speaker__c (after	 insert) {
	...
	//system.debug('Sixe is ' + trigger.new.size());
        for(Session_Speaker__c newItem : trigger.new) {
system.debug('aa '+newItem.Id+' asd '+ newItem.Name);
        ...
        // 
        system.debug('Email - '+sessionSpeaker.Speaker__r.Email__c);
            sessionSpeaker.Speaker__r.Email__c = 'grv.sinha@gmail.com';
